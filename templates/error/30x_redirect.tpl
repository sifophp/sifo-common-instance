...
<head>
	...
	{literal}
		<script type="text/javascript">
			...
			function pause_toggle(force = false)
			{
				if (true == force || false == paused)
				{
					clearTimeout( interval );
...
<div id="redirect_info">
	...
	Redirecting to...<br /> <a id='destination' href='{$error.url_redirect}' onclick="pause_toggle(true);">{$error.url_redirect}</a>
	<pre id='redirect'></pre>
	<a id='pause_btn' href="javascript:pause_toggle();" class="button">Pause</a>
</div>
{/if}
